    ...
    <div className="border-t border-slate-700/50 bg-slate-900/80 backdrop-blur-sm px-4 py-3">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-end gap-2">
          <div className="flex-1 relative">
            <textarea
              ...
              aria-label="Describe your action or ask a question"
        ...
        <p className="text-[10px] text-slate-600 mt-1 text-center">
          Shift+Enter for new line{input.length > MAX_LENGTH * 0.8 ? ` • ${input.length}/${MAX_LENGTH}` : ''} • Describe actions, ask questions, or explore
        </p>
      </div>
    </div>
  );
