...
register('horror', [
  {
    ...
    icon: '🔦',
    description: 'You hunt ghosts, poltergeists, and unexplained phenomena armed with recording equipment and sheer nerve.',
    skillProficiencies: 'Investigation, Perception',
    feature: 'Spirit Sense',
    suggestedTraits: [
      'I document everything — EMF readings, temperature drops, whispers.',
      'I\'ve seen enough to know the dead don\'t always rest.',
      'I stay calm in haunted places because panic is how you die.',
      'I talk to empty rooms. Sometimes they answer.',
    ],
    suggestedIdeals: ['Truth', 'Protection', 'Knowledge', 'Courage'],
    suggestedBonds: [
      'A spirit saved my life when I was young. I need to know why.',
      'My partner vanished during an investigation. I\'m still looking.',
      'I have recordings no one believes are real. They need to.',
    ],
    suggestedFlaws: [
      'I chase dangerous hauntings for the thrill as much as the answers.',
      'I dismiss mundane explanations even when they\'re more likely.',
      'I can\'t sleep without the lights on anymore.',
    ],
  },
  {
    id: 'trauma-survivor',
    ...
    icon: '🩹',
    description: 'You survived something terrible — something that left scars on your mind that won\'t heal.',
    skillProficiencies: 'Survival, Insight',
    feature: 'Hypervigilance',
    suggestedTraits: [
      'I flinch at sounds that remind me of what happened.',
      'I notice exits, weapons, and escape routes before anything else.',
      'I don\'t talk about what happened. Don\'t ask.',
      'I survived. That means something. I just haven\'t figured out what yet.',
    ],
    suggestedIdeals: ['Survival', 'Resilience', 'Justice', 'Healing'],
    suggestedBonds: [
      'Someone died so I could escape. I carry their name.',
      'I\'m trying to warn others about what\'s coming.',
      'The thing that hurt me is still out there. It\'s not finished.',
    ],
    suggestedFlaws: [
      'I freeze at the worst possible moments.',
      'I push away everyone who tries to help me.',
      'I self-medicate and pretend I\'m fine.',
    ],
  },
  {
    id: 'occultist',
    name: 'Occultist',
    icon: '🕯️',
    description: 'You study the forbidden — rituals, summoning circles, and the thin barrier between our world and what lies beyond.',
    skillProficiencies: 'Arcana, Religion',
    feature: 'Forbidden Knowledge',
    suggestedTraits: [
      'I collect grimoires the way others collect books.',
      'I see patterns in the darkness that others miss.',
      'I whisper prayers I don\'t remember learning.',
      'Knowledge is power, even — especially — the dangerous kind.',
    ],
    suggestedIdeals: ['Knowledge', 'Power', 'Understanding', 'Control'],
    suggestedBonds: [
      'A ritual went wrong and something followed me home.',
      'My mentor went mad from the occult. I have to succeed where they failed.',
      'I\'m protecting a seal that must never be broken.',
    ],
    suggestedFlaws: [
      'I tinker with forces I don\'t fully understand.',
      'I rationalize increasingly dangerous rituals.',
      'The things I\'ve seen have eroded my grip on reality.',
    ],
  },
  {
    id: 'skeptic-professor',
    name: 'Skeptic Professor',
    icon: '🎓',
    description: 'An academic who doesn\'t believe in the supernatural — until the evidence becomes impossible to deny.',
    skillProficiencies: 'History, Investigation',
    feature: 'Academic Authority',
    suggestedTraits: [
      'There\'s a rational explanation for everything. There has to be.',
      'I take meticulous notes even when my hands are shaking.',
      'I cite sources mid-argument, even during life-or-death situations.',
      'My worldview is crumbling and I\'m rebuilding it in real time.',
    ],
    suggestedIdeals: ['Reason', 'Truth', 'Knowledge', 'Integrity'],
    suggestedBonds: [
      'My students don\'t know what I\'ve seen. I want to keep it that way.',
      'A colleague\'s research led them to something real. They disappeared.',
      'I found a primary source that describes exactly what\'s happening now.',
    ],
    suggestedFlaws: [
      'I deny the supernatural even when it\'s staring me in the face.',
      'My arrogance makes me underestimate threats.',
      'I need proof before I act, even when hesitation could be fatal.',
    ],
  },
  {
    id: 'cursed-individual',
    name: 'The Cursed',
    icon: '🖤',
    description: 'Something supernatural has latched onto you — a curse, a possession, or a mark that draws darkness near.',
    skillProficiencies: 'Insight, Survival',
    feature: 'Dark Magnetism',
    suggestedTraits: [
      'Bad things happen around me. I try not to take it personally.',
      'I keep people at arm\'s length for their own protection.',
      'I feel the curse like a weight on my chest that never lifts.',
      'I cling to small rituals — they\'re the only control I have.',
    ],
    suggestedIdeals: ['Freedom', 'Endurance', 'Defiance', 'Hope'],
    suggestedBonds: [
      'Someone cursed me deliberately. I will find out who and why.',
      'A loved one is affected by my curse. Breaking it is the only thing that matters.',
      'I found someone else with the same curse. We\'re stronger together.',
    ],
    suggestedFlaws: [
      'I blame myself for every bad thing that happens to those near me.',
      'I\'ve considered giving in to the curse just to make the struggle stop.',
      'I hide my condition from allies until it\'s too late.',
    ],
  },
  {
    id: 'monster-victim',
    name: 'The Changed',
    icon: '🐺',
    description: 'You were bitten, infected, or transformed by something inhuman. You\'re still you — mostly.',
    skillProficiencies: 'Athletics, Stealth',
    feature: 'Bestial Instinct',
    suggestedTraits: [
      'I can smell emotions. Fear is the loudest.',
      'I chain myself up on certain nights. It\'s necessary.',
      'I eat rare meat and tell people I just like it that way.',
      'My senses are sharper, but so is the hunger.',
    ],
    suggestedIdeals: ['Control', 'Identity', 'Isolation', 'Acceptance'],
    suggestedBonds: [
      'The creature that changed me is still out there.',
      'Someone I love would be terrified if they knew what I am.',
      'Another changed individual helps me stay in control. I can\'t lose them.',
    ],
    suggestedFlaws: [
      'I lose control under stress and the beast takes over.',
      'I secretly enjoy the power my condition gives me.',
      'I lie about what I am, even to people who could help.',
    ],
  },
  {
    id: 'asylum-escapee',
    name: 'Asylum Escapee',
    icon: '🏥',
    description: 'You were institutionalized — maybe justifiably, maybe not. You escaped, but the experience stays with you.',
    skillProficiencies: 'Stealth, Insight',
    feature: 'Survival Instinct',
    suggestedTraits: [
      'I talk to people who aren\'t there. Or are they?',
      'I trust my own perception, no matter what others tell me.',
      'I flinch when doors lock behind me.',
      'I survived by being invisible. I\'m still good at it.',
    ],
    suggestedIdeals: ['Freedom', 'Truth', 'Sanity', 'Justice'],
    suggestedBonds: [
      'I left someone behind in the asylum. I have to go back for them.',
      'The doctors saw something in me that frightened them. I need to know what.',
      'I have vivid memories that might be implanted. I need to find the truth.',
    ],
    suggestedFlaws: [
      'I can\'t always tell what\'s real and what isn\'t.',
      'I refuse to take medication, even when I should.',
      'I panic in confined spaces.',
    ],
  },
  {
    id: 'grieving-relative',
    name: 'Grieving Relative',
    icon: '🪦',
    description: 'Someone you loved died under mysterious circumstances. Your grief has become an investigation.',
    skillProficiencies: 'Investigation, Persuasion',
    feature: 'Driven by Loss',
    suggestedTraits: [
      'I carry photos and mementos everywhere.',
      'I won\'t accept "natural causes." Not anymore.',
      'I notice details the police missed because I care more than they do.',
      'Grief has made me stubborn in ways that surprise even me.',
    ],
    suggestedIdeals: ['Justice', 'Truth', 'Love', 'Closure'],
    suggestedBonds: [
      'My loved one\'s death was not an accident. I will prove it.',
      'The police closed the case. I didn\'t.',
      'I found something among their belongings that raises terrifying questions.',
    ],
    suggestedFlaws: [
      'I\'m consumed by my investigation and neglect everything else.',
      'I see connections that might not exist.',
      'I can\'t let go, even when it would be healthier to.',
    ],
  },
]);
...
register('lovecraftian', [
  {
    id: 'antiquarian',
    name: 'Antiquarian',
    icon: '📜',
    description: 'A collector and scholar of ancient artifacts. You\'ve read texts that have unmade lesser minds.',
    skillProficiencies: 'History, Arcana',
    feature: 'Forbidden Archive',
    suggestedTraits: [
      'I speak dead languages more fluently than living ones.',
      'Every artifact has a story. Some of them are screaming.',
      'I handle ancient objects with reverent, trembling hands.',
      'I catalog everything — it\'s the only way to maintain order in my mind.',
    ],
    suggestedIdeals: ['Knowledge', 'Preservation', 'Understanding', 'Caution'],
    suggestedBonds: [
      'I possess a fragment of a text that should not exist.',
      'My collection cost me my family. It had better be worth it.',
      'An artifact I sold has caused terrible things. I need to retrieve it.',
    ],
    suggestedFlaws: [
      'I can\'t resist acquiring a rare artifact, regardless of its nature.',
      'I\'ve read things I can\'t un-read, and they surface in dreams.',
      'I hoard knowledge selfishly, afraid of what others might do with it.',
    ],
  },
  {
    id: 'mad-scholar',
    name: 'Mad Scholar',
    icon: '🧠',
    description: 'You glimpsed a truth beyond human comprehension. Your mind fractured, but in the cracks — you see clearly.',
    skillProficiencies: 'Investigation, Insight',
    feature: 'Fractured Vision',
    suggestedTraits: [
      'I mutter equations and star charts when I\'m stressed.',
      'I see geometry in everything — angles that shouldn\'t exist.',
      'My handwriting has changed since the revelation. I don\'t recognize it.',
      'I laugh at things that aren\'t funny. They\'re just... inevitable.',
    ],
    suggestedIdeals: ['Truth', 'Acceptance', 'Knowledge', 'Surrender'],
    suggestedBonds: [
      'I know what\'s coming. No one believes me, but I have to try.',
      'My research notes contain warnings from my past self that I don\'t remember writing.',
      'A fellow scholar shares my vision. Together we might make sense of it.',
    ],
    suggestedFlaws: [
      'My definition of sanity has become... flexible.',
      'I share dangerous knowledge with people who aren\'t ready for it.',
      'I\'m drawn to the very things that are destroying my mind.',
    ],
  },
  {
    id: 'deep-one-hybrid',
    ...
    icon: '🐟',
    description: 'Something inhuman lurks in your ancestry. As you age, the resemblance grows stronger.',
    skillProficiencies: 'Athletics, Stealth',
    feature: 'Abyssal Heritage',
    suggestedTraits: [
      'I\'m drawn to water in ways I can\'t explain.',
      'My dreams are filled with vast, dark oceans and ancient cities.',
      'I hide the physical changes as long as I can.',
      'I hear singing from deep places. It\'s beautiful. That terrifies me.',
    ],
    suggestedIdeals: ['Identity', 'Defiance', 'Understanding', 'Acceptance'],
    suggestedBonds: [
      'My family kept this secret for generations. I stumbled onto the truth.',
      'Others with my condition embrace it. I\'m not ready to.',
      'A coastal village holds answers about my bloodline.',
    ],
    suggestedFlaws: [
      'I\'m repulsed by my own reflection.',
      'I feel the pull of the deep — and it grows stronger every day.',
      'I keep my condition secret even from those who could help.',
    ],
  },
  {
    id: 'cult-escapee',
    name: 'Cult Escapee',
    icon: '👁️',
    description: 'You escaped a cosmic cult that worships entities beyond human understanding. They want you back.',
    skillProficiencies: 'Deception, Religion',
    feature: 'Ritual Knowledge',
    suggestedTraits: [
      'I know the chants but I\'ve forgotten the exits.',
      'I see cult symbology everywhere — walls, clouds, floor tiles.',
      'I trust no one who speaks too kindly. That\'s how they recruited me.',
      'I pray to things I know are listening, and that\'s the problem.',
    ],
    suggestedIdeals: ['Freedom', 'Vigilance', 'Atonement', 'Survival'],
    suggestedBonds: [
      'I left people behind in the cult. Some of them were children.',
      'The cult marked me. I can feel it when they\'re near.',
      'I carry stolen texts that describe their ultimate ritual.',
    ],
    suggestedFlaws: [
      'I hear the entity\'s whispers when I\'m alone too long.',
      'My escape cost someone else their chance. I carry that guilt.',
      'I sometimes follow cult routines without realizing it.',
    ],
  },
  {
    id: 'dreamwalker',
    name: 'Dreamwalker',
    icon: '💤',
    description: 'You walk the Dreamlands when you sleep — a parallel world of wonder and nightmare that bleeds into waking life.',
    skillProficiencies: 'Perception, Arcana',
    feature: 'Dream Sight',
    suggestedTraits: [
      'I keep a dream journal. It reads like prophecy.',
      'I can\'t always tell if I\'m awake or asleep. Can you?',
      'I find the waking world disappointingly solid.',
      'I\'ve met beings in dreams who know my name.',
    ],
    suggestedIdeals: ['Discovery', 'Wonder', 'Balance', 'Truth'],
    suggestedBonds: [
      'Something in the Dreamlands is calling me. I must answer.',
      'A friend fell asleep and never woke up. I need to find them in the Dreamlands.',
      'I made a promise to a dream entity. I intend to keep it.',
    ],
    suggestedFlaws: [
      'I sleep too much, chasing the dream over reality.',
      'Things I encounter in dreams follow me into the waking world.',
      'I share dream experiences that make people deeply uncomfortable.',
    ],
  },
  {
    id: 'doomed-detective',
    name: 'Doomed Detective',
    icon: '🔍',
    description: 'A private investigator who took a case that led somewhere no rational mind should go.',
    skillProficiencies: 'Investigation, Insight',
    feature: 'Hard-Boiled Resolve',
    suggestedTraits: [
      'I follow the evidence, even when it leads somewhere impossible.',
      'I drink too much. It\'s the only thing that quiets the visions.',
      'I keep asking questions long after sensible people stop.',
      'Every case connects to something bigger. I\'m sure of it.',
    ],
    suggestedIdeals: ['Truth', 'Justice', 'Tenacity', 'Order'],
    suggestedBonds: [
      'A client hired me to find their missing relative. What I found was worse.',
      'My case files contain patterns that spell out something terrifying.',
      'I\'m being watched by things that don\'t cast shadows.',
    ],
    suggestedFlaws: [
      'I can\'t let a mystery go, even at the cost of my sanity.',
      'I trust no one completely — paranoia is my survival mechanism.',
      'I\'ve started carrying a weapon I never thought I\'d need.',
    ],
  },
  {
    ...
    icon: '🎣',
    description: 'You\'ve worked the waters near a cursed coast. You\'ve seen things in the deep that don\'t appear in any chart.',
    skillProficiencies: 'Survival, Perception',
    feature: 'Sea Knowledge',
    suggestedTraits: [
      'I respect the sea. It doesn\'t respect me back.',
      'I tie knots when I\'m nervous. Old habit.',
      'The things I\'ve seen in the water are why I drink on land.',
      'I tell people the fish are just big. That\'s easier than the truth.',
    ],
    suggestedIdeals: ['Survival', 'Loyalty', 'Caution', 'Honesty'],
    suggestedBonds: [
      'My crew saw something that night. We swore never to speak of it.',
      'Something took my father\'s boat. He went looking. He didn\'t come back.',
      'The old lighthouse keeper tried to warn us. I should have listened.',
    ],
    suggestedFlaws: [
      'I won\'t go near the water anymore, yet I can\'t leave the coast.',
      'I keep secrets that are slowly destroying me.',
      'I see shapes in every body of water and it paralyzes me.',
    ],
  },
  {
    id: 'asylum-doctor',
    name: 'Asylum Doctor',
    icon: '🏥',
    description: 'You treated patients with impossible symptoms. Their ravings weren\'t delusions — and now you know it.',
    skillProficiencies: 'Medicine, Insight',
    feature: 'Clinical Detachment',
    suggestedTraits: [
      'I listen to the insane with professional patience — and growing belief.',
      'I keep detailed patient files. The patterns are undeniable.',
      'I maintain a calm, clinical facade no matter what I\'m feeling.',
      'I self-diagnose obsessively, checking for signs of infection.',
    ],
    suggestedIdeals: ['Truth', 'Compassion', 'Knowledge', 'Duty'],
    suggestedBonds: [
      'A patient described exactly what I later witnessed. They were right all along.',
      'I have a colleague who shares my suspicions. We communicate in code.',
      'The asylum board wants me silenced. I know too much.',
    ],
    suggestedFlaws: [
      'I medicalize everything, even the genuinely supernatural.',
      'I experiment on myself to understand what\'s happening.',
      'My clinical detachment has become emotional numbness.',
    ],
  },
]);
...
register('mystery', [
  {
    ...
    icon: '🔍',
    description: 'A licensed investigator who takes the cases the police won\'t touch. You work cheap and drink expensive.',
    skillProficiencies: 'Investigation, Insight',
    feature: 'Street Contacts',
    suggestedTraits: [
      'I notice what people try to hide — it\'s second nature.',
      'I keep a flask for emergencies. Every day has emergencies.',
      'I trust evidence over testimony. People lie; objects don\'t.',
      'I take cases that bother my conscience because someone has to.',
    ],
    suggestedIdeals: ['Truth', 'Justice', 'Independence', 'Persistence'],
    suggestedBonds: [
      'An unsolved case haunts me. I won\'t stop until I crack it.',
      'A client trusted me with their life. I won\'t let them down.',
      'The cops and I have an understanding — mostly.',
    ],
    suggestedFlaws: [
      'I can\'t let a mystery go, even when the case is closed.',
      'I bend the law to serve justice, and the line keeps moving.',
      'I trust my gut over evidence, and it\'s not always right.',
    ],
  },
  {
    id: 'crime-reporter',
    name: 'Crime Reporter',
    icon: '📰',
    description: 'A journalist who covers the crime beat. Your pen is mightier than most swords — and more dangerous.',
    skillProficiencies: 'Investigation, Persuasion',
    feature: 'Press Credentials',
    suggestedTraits: [
      'I can get anyone talking — that\'s the job.',
      'I write stories in my head before the facts are in.',
      'I protect my sources with my life.',
      'Every story has two sides. I publish both and let readers decide.',
    ],
    suggestedIdeals: ['Truth', 'Freedom', 'Public Good', 'Accountability'],
    suggestedBonds: [
      'A whistleblower gave me everything. If their identity leaks, they\'re dead.',
      'My editor killed a story. I\'m running it anyway.',
      'I\'m building a case that could bring down powerful people.',
    ],
    suggestedFlaws: [
      'I sensationalize for clicks and hate myself for it.',
      'I put the story above my personal safety and others\'.',
      'I\'ve traded ethics for access and I know it.',
    ],
  },
  {
    id: 'former-cop',
    name: 'Former Cop',
    icon: '🚔',
    description: 'You left the force — retired, fired, or walked away. But old instincts die hard.',
    skillProficiencies: 'Investigation, Intimidation',
    feature: 'Badge Instincts',
    suggestedTraits: [
      'I still think in case files and evidence chains.',
      'I reach for a badge that isn\'t there anymore.',
      'I interview everyone like a suspect. It\'s not personal.',
      'I know the law inside and out — and where it bends.',
    ],
    suggestedIdeals: ['Justice', 'Order', 'Duty', 'Truth'],
    suggestedBonds: [
      'I left the force over a case I couldn\'t solve. I\'m still working it.',
      'My old partner is still on the force and feeds me information.',
      'I was pushed out for getting too close to someone powerful.',
    ],
    suggestedFlaws: [
      'I still act like I have authority when I don\'t.',
      'I\'m bitter about how my career ended.',
      'I drink to forget the things I saw on the job.',
    ],
  },
  {
    id: 'forensic-specialist',
    name: 'Forensic Specialist',
    icon: '🧪',
    description: 'You read crime scenes like books — blood spatter, fingerprints, and trace evidence tell you the truth others can\'t see.',
    skillProficiencies: 'Investigation, Medicine',
    feature: 'Scene Reader',
    suggestedTraits: [
      'I\'m more comfortable with the dead than the living.',
      'Contaminated evidence bothers me more than violence.',
      'I explain cause of death at dinner parties. People stop inviting me.',
      'Every surface is a potential evidence source in my mind.',
    ],
    suggestedIdeals: ['Truth', 'Precision', 'Justice', 'Science'],
    suggestedBonds: [
      'A piece of evidence I mishandled let a killer go free.',
      'I\'m building a case with evidence no one else has noticed.',
      'A detective trusts my work implicitly. I can\'t let them down.',
    ],
    suggestedFlaws: [
      'I\'m so focused on evidence I forget about the human victims.',
      'I can\'t handle uncertainty — I need definitive answers.',
      'I take work home and it\'s consumed my personal life.',
    ],
  },
  {
    id: 'con-artist',
    name: 'Con Artist',
    icon: '🎭',
    description: 'You\'ve lived a dozen lives and worn a hundred faces. Deception is your art form.',
    skillProficiencies: 'Deception, Performance',
    feature: 'Perfect Cover',
    suggestedTraits: [
      'I become whoever needs to exist for the job.',
      'I\'ve told so many lies I sometimes forget who I really am.',
      'I study people like paintings — every detail matters.',
      'I prefer the con to the take. The game is the reward.',
    ],
    suggestedIdeals: ['Freedom', 'Creativity', 'Profit', 'Thrill'],
    suggestedBonds: [
      'I conned the wrong person and now they\'re after me.',
      'I maintain a real identity somewhere that no one connects to me.',
      'A partner I betrayed deserved better. I owe them.',
    ],
    suggestedFlaws: [
      'I can\'t stop running cons, even when I don\'t need to.',
      'I don\'t know who I am without the masks.',
      'I underestimate marks and overestimate my own cleverness.',
    ],
  },
  {
    id: 'defense-attorney',
    ...
    icon: '⚖️',
    description: 'You defend the accused — guilty or innocent. Everyone deserves representation, but some cases haunt you.',
    skillProficiencies: 'Persuasion, Insight',
    feature: 'Legal Standing',
    suggestedTraits: [
      'I argue for a living. I\'m always on.',
      'I see both sides of every issue, even when I wish I didn\'t.',
      'I never reveal a client\'s secrets, no matter what.',
      'I dress sharply because appearance is the first argument.',
    ],
    suggestedIdeals: ['Justice', 'Fairness', 'Duty', 'Truth'],
    suggestedBonds: [
      'I defended someone I believed was innocent. The verdict still haunts me.',
      'A case I\'m working on has led to something much bigger.',
      'My reputation is my career. One misstep and it\'s over.',
    ],
    suggestedFlaws: [
      'I argue even when it\'s not appropriate.',
      'I\'ve defended people I know are guilty and sleep just fine.',
      'I become obsessed with winning and forget about justice.',
    ],
  },
  {
    ...
    icon: '🔐',
    description: 'You spent years on the wrong side of the law. Now you use what you learned to help solve crimes.',
    skillProficiencies: 'Stealth, Deception',
    feature: 'Criminal Insight',
    suggestedTraits: [
      'I know how criminals think because I was the best.',
      'I spot a rigged game, a picked pocket, or a setup instantly.',
      'I flinch at the sight of handcuffs.',
      'I\'m trying to be good. It\'s harder than being bad.',
    ],
    suggestedIdeals: ['Redemption', 'Justice', 'Change', 'Loyalty'],
    suggestedBonds: [
      'I did time. The people who put me there had good reason.',
      'My old crew doesn\'t know I\'ve gone straight. When they find out...',
      'I\'m making amends to the victims of my past crimes.',
    ],
    suggestedFlaws: [
      'Old habits surface when I\'m under pressure.',
      'I don\'t trust the system that jailed me, even when it works.',
      'I keep one foot in the criminal world "just in case."',
    ],
  },
  {
    id: 'amateur-sleuth',
    name: 'Amateur Sleuth',
    icon: '🧐',
    description: 'An ordinary person with an extraordinary talent for noticing what\'s wrong. You just keep stumbling into mysteries.',
    skillProficiencies: 'Perception, Insight',
    feature: 'Keen Observer',
    suggestedTraits: [
      'I notice tiny inconsistencies that drive me to investigate.',
      'I read mystery novels for fun. Real crimes are... different.',
      'I ask questions that make guilty people very uncomfortable.',
      'I get drawn into trouble without meaning to.',
    ],
    suggestedIdeals: ['Curiosity', 'Justice', 'Community', 'Honesty'],
    suggestedBonds: [
      'A friend or neighbor was the victim. That\'s how this started.',
      'The local police think I\'m a nuisance. I keep proving them wrong.',
      'I stumbled onto something bigger than a single crime.',
    ],
    suggestedFlaws: [
      'I\'m in over my head and don\'t realize it.',
      'I treat real danger like a puzzle instead of a threat.',
      'I can\'t stop investigating even when I\'m told to back off.',
    ],
  },
]);
...
register('political-intrigue', [
  {
    id: 'court-diplomat',
    name: 'Court Diplomat',
    icon: '🏛️',
    description: 'You navigate the treacherous waters of court politics, where a smile can be more deadly than a blade.',
    skillProficiencies: 'Persuasion, Insight',
    feature: 'Court Connections',
    suggestedTraits: [
      'I choose every word as carefully as a chess move.',
      'I smile at enemies and embrace friends with equal warmth.',
      'I keep a mental dossier on everyone I\'ve ever met.',
      'I dress to impress, manipulate, and intimidate — all at once.',
    ],
    suggestedIdeals: ['Order', 'Influence', 'Balance', 'Legacy'],
    suggestedBonds: [
      'I serve a ruler whose secrets I guard with my life.',
      'A rival diplomat outmaneuvered me once. It won\'t happen again.',
      'I brokered a peace that is secretly built on lies.',
    ],
    suggestedFlaws: [
      'I play games with people\'s lives and tell myself it\'s necessary.',
      'I can\'t turn off the political thinking, even with friends.',
      'I\'ve been at court so long I\'ve forgotten who I really am.',
    ],
  },
  {
    id: 'spymaster',
    name: 'Spymaster',
    icon: '🕵️',
    description: 'You run networks of informants and agents. Information is the most dangerous weapon you wield.',
    skillProficiencies: 'Deception, Stealth',
    feature: 'Intelligence Network',
    suggestedTraits: [
      'I know secrets that could topple governments.',
      'I never enter a room without knowing the exits.',
      'I maintain multiple identities for multiple situations.',
      'Trust is a liability I can\'t afford.',
    ],
    suggestedIdeals: ['Security', 'Control', 'Loyalty', 'Pragmatism'],
    suggestedBonds: [
      'My agents are my responsibility. When they burn, I burn.',
      'I serve a cause greater than any single ruler.',
      'A double agent in my network has compromised everything.',
    ],
    suggestedFlaws: [
      'I see threats in every shadow and lie in every smile.',
      'I manipulate friends as reflexively as I manipulate enemies.',
      'I\'ve sacrificed too many agents for the mission.',
    ],
  },
  {
    id: 'disgraced-heir',
    name: 'Disgraced Heir',
    icon: '👑',
    description: 'Born to power, cast from it. You navigate the court from the outside, scheming your way back to relevance.',
    skillProficiencies: 'History, Persuasion',
    feature: 'Fallen Name',
    suggestedTraits: [
      'I remember every slight and every ally who stayed.',
      'I act humble, but my blood remembers what I deserve.',
      'I study power structures the way a locksmith studies locks.',
      'I collect favors like others collect coin.',
    ],
    suggestedIdeals: ['Restoration', 'Justice', 'Power', 'Patience'],
    suggestedBonds: [
      'My family\'s rightful position was stolen. I will reclaim it.',
      'A loyal servant risked everything to smuggle me out. I owe them.',
      'I have proof of the treachery that brought my house down.',
    ],
    suggestedFlaws: [
      'My desire for restoration blinds me to present dangers.',
      'I trust my bloodline\'s right to rule more than my own abilities.',
      'I hold grudges that have become self-destructive obsessions.',
    ],
  },
  {
    id: 'guild-politician',
    name: 'Guild Politician',
    icon: '🤝',
    description: 'You rose through the ranks of a powerful guild or faction, mastering trade, alliances, and backroom deals.',
    skillProficiencies: 'Persuasion, Deception',
    feature: 'Guild Influence',
    suggestedTraits: [
      'I know the price of everything and the value of leverage.',
      'I shake hands with one hand and count the silver with the other.',
      'I draft treaties in my sleep.',
      'Every meeting is a negotiation, even dinner.',
    ],
    suggestedIdeals: ['Prosperity', 'Order', 'Ambition', 'Fairness'],
    suggestedBonds: [
      'My guild is my life. Its enemies are mine.',
      'I uncovered corruption in my own guild. Exposing it means war.',
      'A trade deal I brokered went wrong and people suffered.',
    ],
    suggestedFlaws: [
      'I reduce all relationships to transactional exchanges.',
      'I\'ll sacrifice principles for profit when pushed.',
      'I\'m so cautious I sometimes miss opportunities.',
    ],
  },
  {
    id: 'rebel-leader',
    name: 'Rebel Leader',
    icon: '✊',
    description: 'You lead a movement against tyranny. The cause is righteous, but revolution demands terrible choices.',
    skillProficiencies: 'Persuasion, Stealth',
    feature: 'Underground Movement',
    suggestedTraits: [
      'I inspire loyalty with passion and conviction.',
      'I question every order I give because lives are at stake.',
      'I know the weight of sending people into danger.',
      'I sleep light, eat fast, and move often.',
    ],
    suggestedIdeals: ['Freedom', 'Justice', 'Equality', 'Sacrifice'],
    suggestedBonds: [
      'My movement is more important than my life.',
      'A comrade was captured. Rescuing them could expose the whole network.',
      'The tyrant I fight used to be my friend.',
    ],
    suggestedFlaws: [
      'I sacrifice individuals for the cause without enough hesitation.',
      'I see traitors where there are only doubters.',
      'My idealism prevents me from making necessary compromises.',
    ],
  },
  {
    id: 'royal-advisor',
    name: 'Royal Advisor',
    icon: '📋',
    description: 'You whisper in the ear of power. Your counsel shapes kingdoms, but the crown\'s shadow is a dangerous place to stand.',
    skillProficiencies: 'History, Insight',
    feature: 'Advisor\'s Privilege',
    suggestedTraits: [
      'I speak in suggestions, never demands.',
      'I know more about running this kingdom than the one wearing the crown.',
      'I plan for disasters that haven\'t happened yet.',
      'I maintain a dignified composure regardless of the chaos.',
    ],
    suggestedIdeals: ['Wisdom', 'Stability', 'Service', 'Legacy'],
    suggestedBonds: [
      'I\'ve served three rulers. The current one actually listens.',
      'My advice once led to war. I\'ve been more careful since.',
      'I keep a contingency plan for the day the ruler turns against me.',
    ],
    suggestedFlaws: [
      'I\'ve grown addicted to proximity to power.',
      'I second-guess myself at critical moments.',
      'I believe I\'m indispensable, which makes me careless.',
    ],
  },
  {
    id: 'poison-taster',
    name: 'Poison Taster',
    icon: '🍷',
    description: 'You\'ve spent years sampling food and drink for traces of death. Your palate is exquisite — and scarred.',
    skillProficiencies: 'Medicine, Perception',
    feature: 'Toxic Resilience',
    suggestedTraits: [
      'I can taste the difference between seventeen common poisons.',
      'I eat cautiously, even when I\'m not on duty.',
      'My survival has made me deeply paranoid about food others prepare.',
      'I approach every meal as a potential crime scene.',
    ],
    suggestedIdeals: ['Duty', 'Loyalty', 'Survival', 'Caution'],
    suggestedBonds: [
      'I saved a ruler\'s life by catching a poisoned dish.',
      'I was poisoned and survived. I need to find the poisoner.',
      'I trained an apprentice who may be conspiring against me.',
    ],
    suggestedFlaws: [
      'Years of low-dose exposure have affected my health.',
      'I trust no one who offers me food.',
      'I\'ve become so paranoid I see assassination in every kindness.',
    ],
  },
  {
    id: 'court-assassin',
    name: 'Court Assassin',
    icon: '🗡️',
    description: 'You are the blade in the darkness — the last resort of those who shape history from behind the throne.',
    skillProficiencies: 'Stealth, Deception',
    feature: 'Shadow Skills',
    suggestedTraits: [
      'I never make a sound unless I choose to.',
      'I study my targets until I know them better than they know themselves.',
      'I separate my work from my feelings. Or I try to.',
      'I have rules about who I will and won\'t kill.',
    ],
    suggestedIdeals: ['Discipline', 'Pragmatism', 'Order', 'Freedom'],
    suggestedBonds: [
      'My handler gives the orders. I\'ve never questioned one — until now.',
      'I spared a target who reminded me of someone I lost.',
      'I keep a list of names. The dead ones are crossed out.',
    ],
    suggestedFlaws: [
      'I\'ve killed people who didn\'t deserve it and it\'s catching up to me.',
      'I can\'t form genuine connections — everyone is a potential target.',
      'My profession has made me cold in ways I can\'t undo.',
    ],
  },
]);
